...
<!-- 顶部开始 -->
<div class="container">
    <div class="logo"><a href="./index.html">分类管理_食品药品包装</a></div>
...
<div class="wrapper">
    ...
    <div class="page-content">
        <div class="content">
            ...
            <xblock><a href="spyp-add.php"><button class="layui-btn"><i class="layui-icon">&#xe608;</i>添加</button></a><span class="x-right" style="line-height:40px">
		<!-- 统计表内的数据条数 -->
			<?php
