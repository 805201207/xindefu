...
<head>
    <meta charset="UTF-8">
    <title>分类管理_非标定制_广州信德福智能设备有限公司</title>
...
<body>
    <!-- 顶部开始 -->
    <div class="container">
        <div class="logo"><a href="./index.html">分类管理_非标定制</a></div>
    ...
    <div class="wrapper">
        ...
        <div class="page-content">
          <div class="content">
            ...
            <xblock><button class="layui-btn layui-btn-danger" onclick="delAll()"><i class="layui-icon">&#xe640;</i>批量删除</button><button class="layui-btn" onclick="level_add('添加用户','level-add.html','','600','300')"><i class="layui-icon">&#xe608;</i>添加</button><span class="x-right" style="line-height:40px">共有数据：88 条</span></xblock>
