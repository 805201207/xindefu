...
<html>
	<head>
		<meta charset="utf-8">
		<title>非标定制包装_非标定制包装_广州信德福智能设备有限公司</title>
	...
	<body>
		<div class="wrap">
			...
			<div class="ziyanshi-two">
				<ul class="two-img-top"><img src="img/feibiaodingzhi.jpg" width="100%" height="100%"></ul>
				<ul class="two-img-buttom">
					<li style="font-size: 40px;color:#ffffff;">PRODUCT</li>
					<li style="color:#ffffff;margin-top: 10px;">首页>非标定制包装</li>
				</ul>
			</div>
			<!-- 中部 -->
